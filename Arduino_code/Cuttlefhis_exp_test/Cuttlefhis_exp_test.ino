...
#define starting_point 100  // midpoint of a swings. Please check step_per_mm if the displacement is not the same as desired
#define pause_time 0
...
//  Serial.println(max_accel_in_run/step_per_mm);
  ...
  stepperX.runToNewPosition(starting_point * step_per_mm);
  Serial.println("down!!!");
  delay(200);
...
//       Serial.println(starting_point * step_per_mm + (amplitude / 2)); 
//       delay(pause_time);
//       stepperX.runToNewPosition(starting_point * step_per_mm - (amplitude / 2));
//       Serial.println(starting_point * step_per_mm - (amplitude / 2)); 
//       delay(pause_time);
